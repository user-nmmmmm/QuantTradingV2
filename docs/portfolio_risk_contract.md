...
> 文档状态：Active v1.0
> 生效日期：2026-09-01
> 实现：[`core/candidate_scoring.py`](../core/candidate_scoring.py)、[`core/risk/portfolio_governor.py`](../core/risk/portfolio_governor.py)、[`core/account_cost_contract.py`](../core/account_cost_contract.py)、[`core/phase4.py`](../core/phase4.py)
