...
2026-09-06 验收补充：主分支 `8a89116` 已通过远程 push CI、本地完整测试和覆盖率，
修复后 30 币种当前配置 A/B 独立运行三次且摘要一致，完整材料已本地归档。
证据见 [`baselines/main_20260906/README.md`](baselines/main_20260906/README.md)。
真实 sandbox 调用未执行；归档包未异地上传；以上不改变策略或实盘放行状态。
